...
export default function FamilySafetyPage() {
  ...
  return (
    <div className="space-y-6 pb-16">
      <header>
        <div className="inline-flex items-center gap-2 rounded-full bg-emerald-500/10 px-3 py-1 text-xs font-black text-emerald-200"><ShieldCheck className="h-4 w-4" /> Family Safety</div>
