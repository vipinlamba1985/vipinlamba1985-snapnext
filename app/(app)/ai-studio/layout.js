...
import { Image as ImageIcon, Sparkles, WandSparkles } from 'lucide-react';
  ...
  return (
    <div className="space-y-5">
      <nav className="flex gap-2 overflow-x-auto rounded-2xl border border-white/10 bg-white/[0.03] p-2">
        ...
        <Link href="/ai-studio/image" className="inline-flex whitespace-nowrap items-center gap-2 rounded-xl bg-gradient-to-r from-cyan-500/20 to-purple-500/20 px-4 py-2 text-sm font-bold text-cyan-100 hover:from-cyan-500/30 hover:to-purple-500/30"><ImageIcon className="h-4 w-4"/> Create Image <span className="rounded-full bg-white/10 px-2 py-0.5 text-[10px]">New</span></Link>
