  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6 pb-32 md:pb-12">
      <header className="rounded-[2rem] border border-white/8 bg-gradient-to-br from-white/[0.055] to-white/[0.02] p-5 md:p-6">
        ...
        <p className="mt-2 max-w-2xl text-sm leading-6 text-white/48">Control on-device face detection and cloud face recognition independently. Revoking cloud recognition stops future processing; deleting stored recognition data is a separate verified action.</p>
      </header>
      <FacePrivacyControls />
    </div>
  );
