...
export default function UploadPage() {
  ...
  useEffect(() => () => Object.values(previewsRef.current).forEach((url) => { try { URL.revokeObjectURL(url); } catch {} }), []);
  useEffect(() => {
    if (!uploading) return;
