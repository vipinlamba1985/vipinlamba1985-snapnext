...
export async function POST(request) {
  ...
  if (!reservationIds.length || reservationIds.length !== new Set(supplied.map((value) => value.trim())).size) {
    // Duplicates are valid and normalized, but malformed or empty ids are not.
