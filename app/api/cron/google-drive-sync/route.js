...
export async function GET(request) {
  ...
  // Launch behavior: this cron is recovery for explicit Smart Import work only.
  // It does not scan cloud connections, discover whole libraries, or create
  // automatic Drive/Dropbox/OneDrive jobs.
