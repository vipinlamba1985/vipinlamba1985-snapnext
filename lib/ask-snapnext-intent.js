// Ask SnapNext V1 intent and action routing.
//
...
export const ASK_SNAPNEXT_ACTION_VERSION = 1;
...
export function buildAskSnapNextActions({ query, matchCount = 0, clarificationNeeded = false } = {}) {
  ...
  if (intent === 'create_reel') {
    return [action(
      ...
      'Open Create to review the memories and creation choices before anything is generated or exported.',
    )];
  }
