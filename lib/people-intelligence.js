...
export function faceCropStyle(box = {}) {
  ...
  // Move the detected face center to the thumbnail center, then zoom tightly enough
  // to show head and a little context. The previous transformOrigin approach kept an
  // off-centre face anchored in place instead of actually centring it.
