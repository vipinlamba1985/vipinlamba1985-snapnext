...
async function deleteS3Strict(storageKey) {
  ...
  // A pending multipart upload is a future-write capability. Abort every upload
  // for this exact key before deleting the current object so verified deletion
  // cannot be undone later by completing an already-issued multipart session.
