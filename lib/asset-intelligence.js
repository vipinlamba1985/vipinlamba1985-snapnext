...
// Defined in its own import-free module so search and retrieval can filter by
// it without pulling in the enrichment pipeline. Re-exported here so existing
// importers of this module are unaffected.
export { ASSET_INTELLIGENCE_PIPELINE_VERSION } from '@/lib/asset-intelligence-version';
