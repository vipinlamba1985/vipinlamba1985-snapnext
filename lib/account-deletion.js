...
export async function deleteUserAccountData({ db, userId }) {
  ...
  // Fail closed for storage cleanup. No database-side account cleanup begins
  // until every owned media object has been removed successfully, so a retry
  // can recover without leaving the account half-deleted.
