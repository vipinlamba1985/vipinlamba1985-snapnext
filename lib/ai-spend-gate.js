...
export async function reserveExternalAiSpend({
  ...
  return {
    allowed: true,
    reason: skipUserWallet ? 'prepaid_and_profit_guard_approved' : 'wallet_and_profit_guard_approved',
    billingPolicy: skipUserWallet ? 'prepaid' : 'included',
    approvedCostUsd,
