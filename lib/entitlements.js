...
export const DEV_PLAN_IDS = ['free', 'starter', 'plus', 'pro', 'family', 'super_user'];
...
// plans.js is the only entitlement source of truth. Do not override paid plan limits here.
export const ENTITLEMENT_PLANS = Object.freeze({ ...BASE_PLANS });
