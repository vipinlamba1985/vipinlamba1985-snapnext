export const SMART_SYNC_PROVIDERS = [
  ...
  { id: 'dropbox', name: 'Dropbox', surface: 'web', auth: 'oauth', capabilities: ['browse', 'folders', 'auto_sync', 'priority'], syncStrategy: 'durable_cloud_job' },
  { id: 'onedrive', name: 'Microsoft OneDrive', surface: 'web', auth: 'oauth', capabilities: ['browse', 'folders', 'albums', 'auto_sync', 'priority'], syncStrategy: 'durable_cloud_job' },
