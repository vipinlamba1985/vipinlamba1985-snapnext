export const SMART_SYNC_PROVIDERS = [
  { id: 'google_drive', name: 'Google Drive', surface: 'web', auth: 'oauth', capabilities: ['browse', 'folders', 'auto_sync', 'priority'] },
  { id: 'google_photos', name: 'Google Photos', surface: 'web', auth: 'oauth', capabilities: ['browse', 'albums', 'favorites', 'auto_sync', 'priority'] },
  { id: 'dropbox', name: 'Dropbox', surface: 'web', auth: 'oauth', capabilities: ['browse', 'folders', 'auto_sync', 'priority'] },
  { id: 'onedrive', name: 'Microsoft OneDrive', surface: 'web', auth: 'oauth', capabilities: ['browse', 'folders', 'albums', 'auto_sync', 'priority'] },
  { id: 'ios_photos', name: 'iPhone & iPad Photos', surface: 'native', auth: 'native_permission', capabilities: ['library', 'albums', 'favorites', 'confirmed_people', 'background_upload', 'priority'] },
  { id: 'android_media', name: 'Android Photos & Videos', surface: 'native', auth: 'native_permission', capabilities: ['library', 'albums', 'favorites', 'confirmed_people', 'background_upload', 'priority'] },
];
...
export const DEFAULT_SMART_SYNC_PROFILE = {
  ...
  mode: 'manual',
  rules: [
    { id: 'favorites', type: 'favorites', label: 'Favourites first', enabled: true, priority: 1, targetIds: [] },
    { id: 'recent', type: 'recent', label: 'Recent memories', enabled: true, priority: 2, targetIds: [] },
    { id: 'everything', type: 'everything', label: 'Everything else', enabled: false, priority: 3, targetIds: [] },
  ],
  stopAtCapacity: true,
