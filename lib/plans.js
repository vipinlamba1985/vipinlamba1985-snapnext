...
//  - Free proves the memory value with a small protected AI allowance.
...
export const PLANS = {
  ...
  starter: {
    ...
    aiPerDay: 20, aiPerMonth: 400, downloadsPerDay: 50,
    weeklyExternalAiUsd: 0.03,
    maxUploadBytes: 250 * 1024 ** 2,
    features: ['20 GB storage', '30 AI Credits each week', '2 trusted people', 'Ready-to-post captions', 'Memory search & organization'],
    aiFeatures: { chat: true, studio: false, video: false, command: false },
    color: 'from-violet-500 to-fuchsia-600', popular: false,
    prices: { monthly: { amount: 0.99, stripePriceId: process.env.STRIPE_PRICE_STARTER_MONTHLY || null }, yearly: { amount: 9.99, stripePriceId: process.env.STRIPE_PRICE_STARTER_YEARLY || null } },
  },
  plus: {
    ...
    features: ['75 GB storage', '80 AI Credits each week', 'AI Studio', 'Favorite sharing', 'Larger downloads'],
  ...
  pro: {
    ...
    features: ['200 GB storage', '180 AI Credits each week', 'AI Studio + AI Video', 'AI Command', 'Priority export'],
  ...
  family: {
    ...
    features: ['400 GB family vault', '280 shared AI Credits each week', 'Full SnapNext AI suite', 'Family & Favorite sharing', 'People sync & shared albums'],
    aiFeatures: { chat: true, studio: true, video: true, command: true },
