...
//
// Product strategy:
//  - Free proves the core memory value with useful but limited AI.
...
export const PLANS = {
  free: {
    ...
    features: ['15 GB storage', 'Memory search & chat', '10 AI actions/day', 'Basic gallery & memories'],
  ...
  plus: {
    ...
    features: ['100 GB storage', 'AI Studio', '100 AI actions/day', 'Favorite sharing', 'Larger downloads'],
  ...
  pro: {
    ...
    features: ['1 TB storage', 'AI Studio + AI Video', 'AI Command', '20,000 AI actions/month', 'Priority export'],
  ...
  family: {
    ...
    features: ['2 TB family vault', 'Full SnapNext AI suite', '50,000 AI actions/month', 'Family & Favorite sharing', 'People sync & shared albums'],
    aiFeatures: { chat: true, studio: true, video: true, command: true },
