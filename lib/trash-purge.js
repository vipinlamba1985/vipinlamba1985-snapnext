...
export async function purgeExpiredTrash({
  ...
  for (const candidate of candidates) {
    ...
    try {
      ...
      // purge. The coordinator still moves the user's deletion generation
      // before source storage is removed and invalidates derived renders.
      await coordinatePermanentMediaDeletion({
        db,
        userId: item.userId,
        docs: [item],
        removeRows: false,
