...
export function intelligenceConfig(env = process.env) {
  ...
  return Object.freeze({
    magicSorterEnabled: booleanEnv(env, 'MAGIC_SORTER_ENABLED', true),
    faceProcessingEnabled: booleanEnv(env, 'FACE_PROCESSING_ENABLED', true),
    localFaceGateEnabled: booleanEnv(env, 'LOCAL_FACE_GATE_ENABLED', true),
