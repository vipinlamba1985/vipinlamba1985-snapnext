...
export function buildAccountDeletionFilters({
  ...
  return {
    ...
    memoryRelationships: { userId },
    memoryEvents: { userId },
    memoryStories: { userId },
    readyStoryDrafts: { userId },
    memoryGraphSnapshots: { userId },
    lifeProfiles: { userId },
    lifeEvents: { userId },
    lifeEventDrafts: { userId },
    lifeEventSuggestionFeedback: { userId },
    creativeProjects: { userId },
    exportJobs: { userId },
    ...
    smartSyncPickerSessions: { userId },
