...
export const AI_TASK_REGISTRY = Object.freeze({
  ...
  photo_restore: task({ id: 'photo_restore', featureId: 'vision', pipeline: 'paid_restoration', primary: { provider: 'configured_restoration', modelRole: 'restoration' }, execution: 'async', approvalRequired: true, billingPolicy: 'prepaid', maxCostUsd: 0.06, timeoutMs: 120_000, maxAttempts: 1, dataClasses: ['private_media'] }),
