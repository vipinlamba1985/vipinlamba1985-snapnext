                ...
                <div>
                  ...
                  {timelineData.monthlyRecap ? (
                    ...
                    <p className="text-sm text-white/55 leading-relaxed">
                      No monthly recap yet — add a few memories and this recap will grow from your own uploads.
                    </p>
                  )}
                </div>
                <div className="mt-6 flex items-center gap-2 text-xs text-white/50">
                  <Calendar className="h-4 w-4" /> Built from your library
                </div>
              </div>
              ...
              <div className="p-6 rounded-3xl border border-white/10 bg-gradient-to-b from-pink-950/20 to-transparent flex flex-col justify-between">
                <div>
                  ...
                  {timelineData.yearlyRecap ? (
                    ...
                    <p className="text-sm text-white/55 leading-relaxed">
                      No annual recap yet — SnapNext will summarise this year from your own memories as you upload.
                    </p>
                  )}
                </div>
                <div className="mt-6 flex items-center gap-2 text-xs text-white/50">
